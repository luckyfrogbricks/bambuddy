export default {
  ...
  inventory: {
    ...
    barcode: 'Barcode',
    gtinCode: 'GTIN',
    gtinCodePlaceholder: 'Strichcode, z. B. 6938936716785',
    gtinCodeHelp: 'Wird vom Barcode-Scan automatisch ausgefüllt. Ein späterer Scan eines dieser Codes findet diese Spule sofort.',
    skuCode: 'SKU',
    skuCodePlaceholder: 'z. B. 17600',
    asinCode: 'ASIN',
    asinCodePlaceholder: 'z. B. B0CJLR62MF',
    otherCodeLabel: 'Eigener Code:',
  ...
  spoolbuddy: {
    barcode: {
      ...
      waitingSub: "Der Scanner leuchtet auf und piept, wenn er einen Code liest.",
      invalidScan: "Barcode konnte nicht gelesen werden – bitte erneut scannen.",
      enterManually: "Code manuell eingeben",
      addWithoutBarcode: "Ohne Barcode hinzufügen",
      manualTitle: "Barcode eingeben",
      manualHint: "Gib die Nummer unter dem Barcode ein.",
      lookUp: "Nachschlagen",
      lookingUp: "Wird gesucht…",
      confirmTitle: "Neue Spule bestätigen",
      barcodeScannedTitle: "Barcode gescannt",
      scannedCode: "Gescannt",
      unknownColor: "Unbekannte Farbe",
      rowTag: "Tag",
      rowGross: "Bruttogewicht",
      rowBarcode: "Barcode",
      rowEst: "Geschätztes Filament",
      rescan: "Erneut scannen",
      addToInventory: "Zum Bestand hinzufügen",
      addWithoutTag: "Ohne Tag hinzufügen",
      noMatchTitle: "Kein Treffer gefunden",
      ...
      chipWaiting: "warte…",
      chipEmpty: "leer",
      sourceInventory: "In deinem Bestand gefunden",
      sourceOfd: "In der Open Filament Database gefunden",
      sourceSpoolmandb: "In SpoolmanDB Community gefunden",
      sourceGuessed: "Vom Etikett abgeleitet",
      sourceLinked: "Von dir verknüpft – Barcode für das nächste Mal gespeichert",
      pillInventory: "Dein Bestand",
      ...
      browseCatalog: 'Katalog durchstöbern',
      browseTitle: 'Katalog durchstöbern',
      browseYourBrands: 'Deine Marken',
      browseAllBrands: 'Alle Marken',
      browseColorsCount: '{{count}} Farben',
      browseByColor: 'Farbe',
      browseClearColor: 'Farbfilter entfernen',
      browseShowingTop: '{{count}} von {{total}} angezeigt — Marke wählen zum Eingrenzen',
      browseEmpty: 'Nichts gefunden',
      browseDisabled: 'Community-Katalogabfragen sind deaktiviert. Aktiviere sie in der Web-App unter Einstellungen → Filament, um den Katalog zu durchstöbern.',
      browseLoadFailed: 'Katalog konnte nicht geladen werden',
      sourcePicked: 'Aus dem Katalog gewählt',
      hueRed: 'Rot',
      hueOrange: 'Orange',
      hueYellow: 'Gelb',
      hueGreen: 'Grün',
    ...
    settings: {
      ...
      tabScale: 'Waage',
      tabScanner: "Scanner",
      scannerToggleTitle: "Barcode-Scanner beim Hinzufügen von Spulen verwenden",
      scannerToggleDesc: "Ersetzt den Schnell-Hinzufügen-Dialog auf diesem Gerät durch „Barcode zum Hinzufügen scannen“.",
      scannerNotDetected: "Kein Scanner erkannt – schließe einen USB-Barcode-Scanner an, dann erscheint er hier.",
      scannerHardware: "Erkannte Hardware",
      scannerGeneric: "USB-Barcode-Scanner",
      scannerConnected: "verbunden",
      scannerDisconnected: "nicht verbunden",
      scannerLastScan: "Letzter Scan",
      scannerScanToTest: "Zum Testen scannen",
      scannerTestHint: "Scanne einen beliebigen Barcode zum Testen. Der Code erscheint hier.",
      scannerDbNote: "Abfragen der Community-Datenbanken folgen der Barcode-Scan-Einstellung in der Haupt-App von Bambuddy. Treffer im eigenen Bestand funktionieren immer, auch offline.",
