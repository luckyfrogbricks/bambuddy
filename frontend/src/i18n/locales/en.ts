export default {
  ...
  inventory: {
    ...
    barcode: 'Barcode',
    gtinCode: 'GTIN',
    gtinCodePlaceholder: 'Retail barcode, e.g. 6938936716785',
    gtinCodeHelp: 'Filled in automatically by Scan Barcode. A future scan of any code below matches this spool instantly.',
    skuCode: 'SKU',
    skuCodePlaceholder: 'e.g. 17600',
    asinCode: 'ASIN',
    asinCodePlaceholder: 'e.g. B0CJLR62MF',
    otherCodeLabel: 'Custom code:',
  ...
  spoolbuddy: {
    barcode: {
      ...
      waitingSub: 'The scanner lights up and beeps when it reads a code.',
      invalidScan: "Couldn't read that barcode — try scanning again.",
      enterManually: 'Enter Code Manually',
      addWithoutBarcode: 'Add Without Barcode',
      manualTitle: 'Enter Barcode',
      manualHint: 'Type the number printed below the barcode.',
      lookUp: 'Look Up',
      lookingUp: 'Looking up…',
      confirmTitle: 'Confirm New Spool',
      barcodeScannedTitle: 'Barcode Scanned',
      scannedCode: 'Scanned',
      unknownColor: 'Unknown color',
      rowTag: 'Tag',
      rowGross: 'Gross weight',
      rowBarcode: 'Barcode',
      rowEst: 'Est. filament',
      rescan: 'Rescan',
      addToInventory: 'Add to Inventory',
      addWithoutTag: 'Add Without Tag',
      ...
      chipWaiting: 'waiting…',
      chipEmpty: 'empty',
      sourceInventory: 'Matched in your inventory',
      sourceOfd: 'Matched in Open Filament Database',
      sourceSpoolmandb: 'Matched in SpoolmanDB Community',
      sourceGuessed: 'Guessed from label',
      sourceLinked: 'Linked by you — barcode saved for next time',
      pillInventory: 'Your inventory',
      ...
      browseYourBrands: 'Your brands',
      browseAllBrands: 'All brands',
      browseColorsCount: '{{count}} colors',
      browseByColor: 'Color',
      browseClearColor: 'Clear color filter',
      browseShowingTop: 'Showing {{count}} of {{total}} — pick a brand to narrow down',
      ...
      browseLoadFailed: "Couldn't load the catalog",
      sourcePicked: 'Picked from the catalog',
      hueRed: 'Red',
      hueOrange: 'Orange',
      hueYellow: 'Yellow',
      hueGreen: 'Green',
    ...
    settings: {
      ...
      tabScale: 'Scale',
      tabScanner: 'Scanner',
      scannerToggleTitle: 'Use barcode scanner when adding spools',
      scannerToggleDesc: 'Replaces the quick-add dialog with Scan Barcode to Add on this device.',
      scannerNotDetected: 'No scanner detected — connect a USB barcode scanner and it will appear here.',
      scannerHardware: 'Detected hardware',
      scannerGeneric: 'USB barcode scanner',
      scannerConnected: 'connected',
      scannerDisconnected: 'not connected',
      scannerLastScan: 'Last scan',
      scannerScanToTest: 'Scan to test',
      scannerTestHint: 'Scan any barcode to test. The code appears here.',
      scannerDbNote:
