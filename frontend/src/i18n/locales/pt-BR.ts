export default {
  ...
  inventory: {
    ...
    gtinCode: 'GTIN',
    gtinCodePlaceholder: 'Código de barras, ex.: 6938936716785',
    gtinCodeHelp: 'Preenchido automaticamente pelo escaneamento. Um escaneamento futuro de qualquer um destes códigos encontrará este carretel na hora.',
    skuCode: 'SKU',
    skuCodePlaceholder: 'ex.: 17600',
    asinCode: 'ASIN',
    asinCodePlaceholder: 'ex.: B0CJLR62MF',
    otherCodeLabel: 'Código próprio:',
  ...
  spoolbuddy: {
    barcode: {
      ...
      newLocation: 'Nova…',
      newLocationPlaceholder: 'Nome da nova localização…',
      details: 'Detalhes',
      nozzleTemp: 'Temp. do bico',
      scanTitle: "Escanear código para adicionar",
      scanHint: "Posicione o código de barras em frente à porta do scanner do SpoolBuddy.",
      waiting: "Aguardando leitura…",
      waitingSub: "O scanner acende e apita quando lê um código.",
      invalidScan: "Não foi possível ler esse código de barras — tente escanear novamente.",
      enterManually: "Inserir código manualmente",
      addWithoutBarcode: "Adicionar sem código de barras",
      manualTitle: "Inserir código de barras",
      manualHint: "Digite o número impresso abaixo do código de barras.",
      lookUp: "Buscar",
      lookingUp: "Buscando…",
      confirmTitle: "Confirmar novo carretel",
      barcodeScannedTitle: "Código escaneado",
      scannedCode: "Escaneado",
      unknownColor: "Cor desconhecida",
      rowTag: "Tag",
      rowGross: "Peso bruto",
      rowBarcode: "Código de barras",
      rowEst: "Filamento estimado",
      rescan: "Escanear novamente",
      addToInventory: "Adicionar ao inventário",
      addWithoutTag: "Adicionar sem tag",
      ...
      chipEmpty: "vazia",
      sourceInventory: "Encontrado no seu inventário",
      sourceOfd: "Encontrado no Open Filament Database",
      sourceSpoolmandb: "Encontrado no SpoolmanDB Community",
      sourceGuessed: "Deduzido do rótulo",
      sourceLinked: "Vinculado por você — código de barras salvo para a próxima vez",
      pillInventory: "Seu inventário",
      ...
      browseTitle: 'Explorar catálogo',
      browseYourBrands: 'Suas marcas',
      browseAllBrands: 'Todas as marcas',
      browseColorsCount: '{{count}} cores',
      browseByColor: 'Cor',
      browseClearColor: 'Limpar filtro de cor',
      browseShowingTop: 'Mostrando {{count}} de {{total}} — escolha uma marca para refinar',
      browseEmpty: 'Nada por aqui',
      browseDisabled: 'As consultas aos catálogos da comunidade estão desativadas. Ative-as no app web em Configurações → Filamento para explorar o catálogo.',
      browseLoadFailed: 'Não foi possível carregar o catálogo',
      sourcePicked: 'Escolhido do catálogo',
      hueRed: 'Vermelho',
      hueOrange: 'Laranja',
      hueYellow: 'Amarelo',
      hueGreen: 'Verde',
    ...
    settings: {
      ...
      tabScale: 'Balança',
      tabScanner: "Scanner",
      scannerToggleTitle: "Usar o scanner de código de barras ao adicionar carretéis",
      scannerToggleDesc: "Substitui a caixa de diálogo de adição rápida por «Escanear código para adicionar» neste dispositivo.",
      scannerNotDetected: "Nenhum scanner detectado — conecte um scanner de código de barras USB e ele aparecerá aqui.",
      scannerHardware: "Hardware detectado",
      scannerGeneric: "Scanner de código de barras USB",
      scannerConnected: "conectado",
      scannerDisconnected: "não conectado",
      scannerLastScan: "Última leitura",
      scannerScanToTest: "Escaneie para testar",
      scannerTestHint: "Escaneie qualquer código de barras para testar. O código aparece aqui.",
      scannerDbNote: "As buscas nos bancos de dados da comunidade seguem a configuração de Leitura de código de barras no app principal do Bambuddy. Correspondências no seu próprio inventário sempre funcionam, mesmo offline.",
