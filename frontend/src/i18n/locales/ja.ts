export default {
  ...
  inventory: {
    ...
    barcode: 'バーコード',
    gtinCode: 'GTIN',
    gtinCodePlaceholder: '小売バーコード（例: 6938936716785）',
    gtinCodeHelp: 'バーコードスキャンで自動入力されます。以下のいずれかのコードを後でスキャンすると、このスプールが即座に見つかります。',
    skuCode: 'SKU',
    skuCodePlaceholder: '例: 17600',
    asinCode: 'ASIN',
    asinCodePlaceholder: '例: B0CJLR62MF',
    otherCodeLabel: 'カスタムコード:',
  ...
  spoolbuddy: {
    barcode: {
      ...
      waiting: "スキャン待ち…",
      waitingSub: "コードを読み取るとスキャナーが点灯してビープ音が鳴ります。",
      invalidScan: "バーコードを読み取れませんでした。もう一度スキャンしてください。",
      enterManually: "コードを手動入力",
      addWithoutBarcode: "バーコードなしで追加",
      manualTitle: "バーコードを入力",
      manualHint: "バーコードの下に印字された番号を入力してください。",
      lookUp: "検索",
      lookingUp: "検索中…",
      confirmTitle: "新しいスプールを確認",
      barcodeScannedTitle: "バーコードをスキャンしました",
      scannedCode: "スキャン済み",
      unknownColor: "不明な色",
      rowTag: "タグ",
      rowGross: "総重量",
      ...
      rescan: "再スキャン",
      addToInventory: "在庫に追加",
      addWithoutTag: "タグなしで追加",
      noMatchTitle: "一致するものが見つかりません",
      ...
      chipWaiting: "待機中…",
      chipEmpty: "空",
      sourceInventory: "あなたの在庫で見つかりました",
      sourceOfd: "Open Filament Databaseで見つかりました",
      sourceSpoolmandb: "SpoolmanDB Communityで見つかりました",
      sourceGuessed: "ラベルから推定",
      sourceLinked: "あなたが紐付けました — 次回のためにバーコードを保存しました",
      pillInventory: "あなたの在庫",
      ...
      browseTitle: 'カタログを見る',
      browseYourBrands: '使用中のブランド',
      browseAllBrands: 'すべてのブランド',
      browseColorsCount: '{{count}} 色',
      browseByColor: '色',
      browseClearColor: '色フィルターを解除',
      browseShowingTop: '{{total}} 件中 {{count}} 件を表示 — ブランドを選んで絞り込み',
      browseEmpty: '該当なし',
      browseDisabled: 'コミュニティカタログの照会は無効です。Webアプリの設定 → フィラメントで有効にするとカタログを閲覧できます。',
      browseLoadFailed: 'カタログを読み込めませんでした',
      sourcePicked: 'カタログから選択',
      hueRed: '赤',
      hueOrange: 'オレンジ',
      hueYellow: '黄',
      hueGreen: '緑',
    ...
    settings: {
      ...
      tabScale: '計量',
      tabScanner: "スキャナー",
      scannerToggleTitle: "スプール追加時にバーコードスキャナーを使う",
      scannerToggleDesc: "このデバイスでクイック追加ダイアログを「バーコードをスキャンして追加」に置き換えます。",
      scannerNotDetected: "スキャナーが検出されません — USBバーコードスキャナーを接続するとここに表示されます。",
      scannerHardware: "検出されたハードウェア",
      scannerGeneric: "USBバーコードスキャナー",
      scannerConnected: "接続済み",
      scannerDisconnected: "未接続",
      scannerLastScan: "最後のスキャン",
      scannerScanToTest: "スキャンしてテスト",
      scannerTestHint: "任意のバーコードをスキャンしてテストします。コードがここに表示されます。",
      scannerDbNote: "コミュニティデータベースの検索は、Bambuddy本体アプリのバーコードスキャン設定に従います。自分の在庫との一致はオフラインでも常に機能します。",
      tabUpdates: 'アップデート',
      // Device tab
      nfcReader: 'NFCリーダー',
      type: 'タイプ',
