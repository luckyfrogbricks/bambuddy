export default {
  ...
  inventory: {
    ...
    gtinCode: 'GTIN',
    gtinCodePlaceholder: 'Codice a barre, es. 6938936716785',
    gtinCodeHelp: 'Compilato automaticamente dalla scansione. Una futura scansione di uno di questi codici troverà subito questa bobina.',
    skuCode: 'SKU',
    skuCodePlaceholder: 'es. 17600',
    asinCode: 'ASIN',
    asinCodePlaceholder: 'es. B0CJLR62MF',
    otherCodeLabel: 'Codice personale:',
  ...
  spoolbuddy: {
    barcode: {
      ...
      newLocation: 'Nuova…',
      newLocationPlaceholder: 'Nome della nuova posizione…',
      details: 'Dettagli',
      nozzleTemp: 'Temp. ugello',
      scanTitle: "Scansiona codice per aggiungere",
      scanHint: "Tieni il codice a barre davanti alla porta dello scanner di SpoolBuddy.",
      waiting: "In attesa di scansione…",
      waitingSub: "Lo scanner si illumina ed emette un bip quando legge un codice.",
      invalidScan: "Impossibile leggere il codice a barre — riprova.",
      enterManually: "Inserisci codice manualmente",
      addWithoutBarcode: "Aggiungi senza codice a barre",
      manualTitle: "Inserisci codice a barre",
      manualHint: "Digita il numero stampato sotto il codice a barre.",
      lookUp: "Cerca",
      lookingUp: "Ricerca…",
      confirmTitle: "Conferma nuova bobina",
      barcodeScannedTitle: "Codice scansionato",
      scannedCode: "Scansionato",
      unknownColor: "Colore sconosciuto",
      rowTag: "Tag",
      rowGross: "Peso lordo",
      rowBarcode: "Codice a barre",
      rowEst: "Filamento stimato",
      rescan: "Riscansiona",
      addToInventory: "Aggiungi all'inventario",
      addWithoutTag: "Aggiungi senza tag",
      noMatchTitle: "Nessuna corrispondenza",
      ...
      chipTag: "Tag",
      chipScale: "Bilancia",
      chipWaiting: "in attesa…",
      chipEmpty: "vuota",
      sourceInventory: "Trovato nel tuo inventario",
      sourceOfd: "Trovato in Open Filament Database",
      sourceSpoolmandb: "Trovato in SpoolmanDB Community",
      sourceGuessed: "Dedotto dall'etichetta",
      sourceLinked: "Collegato da te — codice a barre salvato per la prossima volta",
      pillInventory: "Il tuo inventario",
      ...
      browseYourBrands: 'I tuoi marchi',
      browseAllBrands: 'Tutti i marchi',
      browseColorsCount: '{{count}} colori',
      browseByColor: 'Colore',
      browseClearColor: 'Rimuovi filtro colore',
      browseShowingTop: 'Mostrati {{count}} su {{total}} — scegli un marchio per restringere',
      browseEmpty: 'Niente qui',
      browseDisabled: 'Le ricerche nei cataloghi della community sono disattivate. Attivale nell’app web in Impostazioni → Filamento per sfogliare il catalogo.',
      browseLoadFailed: 'Impossibile caricare il catalogo',
      sourcePicked: 'Scelto dal catalogo',
      hueRed: 'Rosso',
      hueOrange: 'Arancione',
      hueYellow: 'Giallo',
      hueGreen: 'Verde',
    ...
    settings: {
      ...
      tabScale: 'Bilancia',
      tabScanner: "Scanner",
      scannerToggleTitle: "Usa lo scanner di codici a barre quando aggiungi bobine",
      scannerToggleDesc: "Sostituisce la finestra di aggiunta rapida con «Scansiona codice per aggiungere» su questo dispositivo.",
      scannerNotDetected: "Nessuno scanner rilevato — collega uno scanner di codici a barre USB e apparirà qui.",
      scannerHardware: "Hardware rilevato",
      scannerGeneric: "Scanner di codici a barre USB",
      scannerConnected: "connesso",
      scannerDisconnected: "non connesso",
      scannerLastScan: "Ultima scansione",
      scannerScanToTest: "Scansiona per testare",
      scannerTestHint: "Scansiona un codice a barre qualsiasi per testare. Il codice appare qui.",
      scannerDbNote: "Le ricerche nei database della community seguono l'impostazione Scansione codice a barre nell'app principale di Bambuddy. Le corrispondenze nel tuo inventario funzionano sempre, anche offline.",
