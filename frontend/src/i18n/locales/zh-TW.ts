export default {
  ...
  inventory: {
    ...
    barcode: '條碼',
    gtinCode: 'GTIN',
    gtinCodePlaceholder: '零售條碼，例如 6938936716785',
    gtinCodeHelp: '掃碼時自動填寫。之後掃描以下任一編碼即可立即匹配到此線軸。',
    skuCode: 'SKU',
    skuCodePlaceholder: '例如 17600',
    asinCode: 'ASIN',
    asinCodePlaceholder: '例如 B0CJLR62MF',
    otherCodeLabel: '自訂編碼：',
  ...
  spoolbuddy: {
    barcode: {
      ...
      noLocation: '無位置',
      newLocation: '新建…',
      newLocationPlaceholder: '新位置名稱…',
      details: '詳情',
      nozzleTemp: '噴嘴溫度',
      scanTitle: "掃描條碼以新增",
      scanHint: "將零售條碼對準 SpoolBuddy 的掃描孔。",
      waiting: "等待掃描…",
      waitingSub: "掃描器讀取到條碼時會亮起並發出提示音。",
      invalidScan: "無法讀取該條碼——請重新掃描。",
      enterManually: "手動輸入條碼",
      addWithoutBarcode: "不使用條碼新增",
      manualTitle: "輸入條碼",
      manualHint: "輸入條碼下方印製的數字。",
      lookUp: "查詢",
      lookingUp: "查詢中…",
      confirmTitle: "確認新料盤",
      barcodeScannedTitle: "已掃描條碼",
      scannedCode: "已掃描",
      unknownColor: "未知顏色",
      rowTag: "標籤",
      rowGross: "毛重",
      ...
      rescan: "重新掃描",
      addToInventory: "新增至庫存",
      addWithoutTag: "不使用標籤新增",
      noMatchTitle: "找不到相符項目",
      noMatchBody: "此條碼不在你的庫存或社群資料庫中。Amazon 包裝盒通常帶有 Amazon 編碼而非零售條碼——請檢查盒上是否有第二個條碼。",
      addBasicSpool: "新增基本料盤",
      findFilament: "尋找此耗材…",
      findTitle: "尋找此耗材",
      findHint: "依品牌、材料或顏色搜尋，然後將此條碼連結到它。",
      findPlaceholder: "例如 polymaker 炭黑",
      findNoResults: "找不到相符項目",
      chipTag: "標籤",
      chipScale: "秤重",
      chipWaiting: "等待中…",
      chipEmpty: "空",
      sourceInventory: "在你的庫存中找到",
      sourceOfd: "在 Open Filament Database 中找到",
      sourceSpoolmandb: "在 SpoolmanDB Community 中找到",
      sourceGuessed: "根據標籤推測",
      sourceLinked: "由你連結——條碼已儲存供下次使用",
      pillInventory: "你的庫存",
      ...
      browseCatalog: '瀏覽目錄',
      browseTitle: '瀏覽目錄',
      browseYourBrands: '我的品牌',
      browseAllBrands: '全部品牌',
      browseColorsCount: '{{count}} 種顏色',
      browseByColor: '顏色',
      browseClearColor: '清除顏色篩選',
      browseShowingTop: '顯示 {{total}} 個中的 {{count}} 個 — 選擇品牌以縮小範圍',
      browseEmpty: '這裡沒有內容',
      browseDisabled: '社群目錄查詢已關閉。請在網頁版的「設定 → 線材」中開啟後再瀏覽目錄。',
      browseLoadFailed: '無法載入目錄',
      sourcePicked: '從目錄中選擇',
      hueRed: '紅',
      hueOrange: '橙',
      hueYellow: '黃',
    ...
    settings: {
      ...
      tabScale: '磅秤',
      tabScanner: "掃描器",
      scannerToggleTitle: "新增料盤時使用條碼掃描器",
      scannerToggleDesc: "在此裝置上，以「掃描條碼以新增」取代快速新增對話框。",
      scannerNotDetected: "未偵測到掃描器——連接 USB 條碼掃描器後將顯示於此。",
      scannerHardware: "偵測到的硬體",
      scannerGeneric: "USB 條碼掃描器",
      scannerConnected: "已連接",
      scannerDisconnected: "未連接",
      scannerLastScan: "最近掃描",
      scannerScanToTest: "掃描以測試",
      scannerTestHint: "掃描任意條碼進行測試，條碼將顯示於此。",
      scannerDbNote: "社群資料庫查詢遵循 Bambuddy 主應用程式中的條碼掃描設定。與自有庫存的比對一律有效，即使離線也是如此。",
      tabUpdates: '更新',
      // Device tab
      nfcReader: 'NFC 讀卡器',
      type: '類型',
