export default {
  ...
  inventory: {
    ...
    gtinCode: 'GTIN',
    gtinCodePlaceholder: 'Código de barras, p. ej. 6938936716785',
    gtinCodeHelp: 'Se rellena automáticamente al escanear. Un escaneo futuro de cualquiera de estos códigos encontrará esta bobina al instante.',
    skuCode: 'SKU',
    skuCodePlaceholder: 'p. ej. 17600',
    asinCode: 'ASIN',
    asinCodePlaceholder: 'p. ej. B0CJLR62MF',
    otherCodeLabel: 'Código propio:',
  ...
  spoolbuddy: {
    barcode: {
      ...
      waitingSub: "El escáner se ilumina y pita cuando lee un código.",
      invalidScan: "No se pudo leer ese código de barras: inténtalo de nuevo.",
      enterManually: "Introducir código manualmente",
      addWithoutBarcode: "Añadir sin código de barras",
      manualTitle: "Introducir código de barras",
      manualHint: "Escribe el número impreso debajo del código de barras.",
      lookUp: "Buscar",
      lookingUp: "Buscando…",
      confirmTitle: "Confirmar nueva bobina",
      ...
      addToInventory: "Añadir al inventario",
      addWithoutTag: "Añadir sin etiqueta",
      ...
      chipTag: "Etiqueta",
      chipScale: "Báscula",
      chipWaiting: "esperando…",
      chipEmpty: "vacía",
      sourceInventory: "Encontrado en tu inventario",
      sourceOfd: "Encontrado en Open Filament Database",
      sourceSpoolmandb: "Encontrado en SpoolmanDB Community",
      sourceGuessed: "Deducido de la etiqueta",
      sourceLinked: "Vinculado por ti: código de barras guardado para la próxima vez",
      pillInventory: "Tu inventario",
      ...
      browseYourBrands: 'Tus marcas',
      browseAllBrands: 'Todas las marcas',
      browseColorsCount: '{{count}} colores',
      browseByColor: 'Color',
      browseClearColor: 'Quitar filtro de color',
      browseShowingTop: 'Mostrando {{count}} de {{total}} — elige una marca para acotar',
      browseEmpty: 'Nada por aquí',
      browseDisabled: 'Las búsquedas en catálogos de la comunidad están desactivadas. Actívalas en la aplicación web en Ajustes → Filamento para explorar el catálogo.',
      browseLoadFailed: 'No se pudo cargar el catálogo',
      sourcePicked: 'Elegido del catálogo',
      hueRed: 'Rojo',
      hueOrange: 'Naranja',
      hueYellow: 'Amarillo',
      hueGreen: 'Verde',
    ...
    settings: {
      ...
      tabScale: 'Báscula',
      tabScanner: "Escáner",
      scannerToggleTitle: "Usar el escáner de códigos al añadir bobinas",
      scannerToggleDesc: "Reemplaza el diálogo de añadido rápido por «Escanear código para añadir» en este dispositivo.",
      scannerNotDetected: "No se detectó ningún escáner: conecta un escáner de códigos USB y aparecerá aquí.",
      scannerHardware: "Hardware detectado",
      scannerGeneric: "Escáner de códigos USB",
      scannerConnected: "conectado",
      scannerDisconnected: "no conectado",
      scannerLastScan: "Último escaneo",
      scannerScanToTest: "Escanea para probar",
      scannerTestHint: "Escanea cualquier código para probar. El código aparecerá aquí.",
      scannerDbNote: "Las búsquedas en las bases de datos de la comunidad siguen la opción de Escaneo de códigos de la app principal de Bambuddy. Las coincidencias con tu propio inventario siempre funcionan, incluso sin conexión.",
