export default {
  ...
  inventory: {
    ...
    barcode: 'Barkod',
    gtinCode: 'GTIN',
    gtinCodePlaceholder: 'Barkod, örn. 6938936716785',
    gtinCodeHelp: 'Barkod taramasıyla otomatik doldurulur. Bu kodlardan herhangi biri ileride taranırsa bu makara anında bulunur.',
    skuCode: 'SKU',
    skuCodePlaceholder: 'örn. 17600',
    asinCode: 'ASIN',
    asinCodePlaceholder: 'örn. B0CJLR62MF',
    otherCodeLabel: 'Özel kod:',
  ...
  spoolbuddy: {
    barcode: {
      ...
      waitingSub: "Tarayıcı bir kod okuduğunda yanar ve bip sesi çıkarır.",
      invalidScan: "Bu barkod okunamadı — tekrar taramayı dene.",
      enterManually: "Kodu elle gir",
      addWithoutBarcode: "Barkodsuz ekle",
      manualTitle: "Barkod gir",
      manualHint: "Barkodun altında yazılı numarayı gir.",
      lookUp: "Ara",
      lookingUp: "Aranıyor…",
      confirmTitle: "Yeni makarayı onayla",
      barcodeScannedTitle: "Barkod tarandı",
      scannedCode: "Tarandı",
      unknownColor: "Bilinmeyen renk",
      rowTag: "Etiket",
      rowGross: "Brüt ağırlık",
      rowBarcode: "Barkod",
      rowEst: "Tahmini filament",
      rescan: "Yeniden tara",
      addToInventory: "Envantere ekle",
      addWithoutTag: "Etiketsiz ekle",
      ...
      chipTag: "Etiket",
      chipScale: "Tartı",
      chipWaiting: "bekleniyor…",
      chipEmpty: "boş",
      sourceInventory: "Envanterinde bulundu",
      sourceOfd: "Open Filament Database'de bulundu",
      sourceSpoolmandb: "SpoolmanDB Community'de bulundu",
      sourceGuessed: "Etiketten tahmin edildi",
      sourceLinked: "Senin tarafından bağlandı — barkod bir sonraki sefer için kaydedildi",
      pillInventory: "Envanterin",
      ...
      browseYourBrands: 'Markalarınız',
      browseAllBrands: 'Tüm markalar',
      browseColorsCount: '{{count}} renk',
      browseByColor: 'Renk',
      browseClearColor: 'Renk filtresini temizle',
      browseShowingTop: '{{total}} sonuçtan {{count}} tanesi gösteriliyor — daraltmak için marka seçin',
      browseEmpty: 'Burada bir şey yok',
      browseDisabled: 'Topluluk kataloğu sorguları kapalı. Kataloğa göz atmak için web uygulamasında Ayarlar → Filament altından açın.',
      browseLoadFailed: 'Katalog yüklenemedi',
      sourcePicked: 'Katalogdan seçildi',
      hueRed: 'Kırmızı',
      hueOrange: 'Turuncu',
      hueYellow: 'Sarı',
      hueGreen: 'Yeşil',
    ...
    settings: {
      ...
      tabScale: 'Tartı',
      tabScanner: "Tarayıcı",
      scannerToggleTitle: "Makara eklerken barkod tarayıcı kullan",
      scannerToggleDesc: "Bu cihazda hızlı ekleme penceresini «Eklemek için barkod tara» ile değiştirir.",
      scannerNotDetected: "Tarayıcı algılanmadı — bir USB barkod tarayıcı bağla, burada görünecek.",
      scannerHardware: "Algılanan donanım",
      scannerGeneric: "USB barkod tarayıcı",
      scannerConnected: "bağlı",
      scannerDisconnected: "bağlı değil",
      scannerLastScan: "Son tarama",
      scannerScanToTest: "Test için tara",
      scannerTestHint: "Test için herhangi bir barkod tara. Kod burada görünür.",
      scannerDbNote: "Topluluk veritabanı aramaları, Bambuddy ana uygulamasındaki Barkod Tarama ayarını izler. Kendi envanterinle eşleşmeler çevrimdışıyken bile her zaman çalışır.",
