export default {
  ...
  inventory: {
    ...
    barcode: '条形码',
    gtinCode: 'GTIN',
    gtinCodePlaceholder: '零售条码，例如 6938936716785',
    gtinCodeHelp: '扫码时自动填写。以后扫描以下任一编码即可立即匹配到此线轴。',
    skuCode: 'SKU',
    skuCodePlaceholder: '例如 17600',
    asinCode: 'ASIN',
    asinCodePlaceholder: '例如 B0CJLR62MF',
    otherCodeLabel: '自定义编码：',
  ...
  spoolbuddy: {
    barcode: {
      ...
      waiting: "等待扫描…",
      waitingSub: "扫描器读取到条码时会亮起并发出提示音。",
      invalidScan: "无法读取该条码——请重新扫描。",
      enterManually: "手动输入条码",
      addWithoutBarcode: "不使用条码添加",
      manualTitle: "输入条码",
      manualHint: "输入条码下方印刷的数字。",
      lookUp: "查询",
      lookingUp: "查询中…",
      confirmTitle: "确认新料盘",
      ...
      chipWaiting: "等待中…",
      chipEmpty: "空",
      sourceInventory: "在你的库存中找到",
      sourceOfd: "在 Open Filament Database 中找到",
      sourceSpoolmandb: "在 SpoolmanDB Community 中找到",
      sourceGuessed: "根据标签推测",
      sourceLinked: "由你关联——条码已保存以备下次使用",
      pillInventory: "你的库存",
      pillOfd: "Open Filament DB",
      pillSpoolmandb: "SpoolmanDB",
      dashHint: "或直接扫描包装盒条码——无需点按",
      addedToast: "已添加到库存",
      alreadyInInventory: "该料盘已在你的库存中",
      refillTitle: "这是补充装（无料盘）",
      refillHint: "补充装是不带料盘出售的裸线卷——芯重更低。",
      refillTooHeavy: "比裸补充装更重——是否装在料盘上？",
      withSpoolTooLight: "比空料盘更轻——这是补充装吗？",
      browseCatalog: '浏览目录',
      browseTitle: '浏览目录',
      browseYourBrands: '我的品牌',
      browseAllBrands: '全部品牌',
      browseColorsCount: '{{count}} 种颜色',
      browseByColor: '颜色',
      browseClearColor: '清除颜色筛选',
      browseShowingTop: '显示 {{total}} 个中的 {{count}} 个 — 选择品牌以缩小范围',
      browseEmpty: '暂无内容',
      browseDisabled: '社区目录查询已关闭。请在网页端的“设置 → 耗材”中开启后再浏览目录。',
      browseLoadFailed: '无法加载目录',
      sourcePicked: '从目录中选择',
      hueRed: '红',
      hueOrange: '橙',
      hueYellow: '黄',
    ...
    settings: {
      ...
      tabScale: '秤',
      tabScanner: "扫描器",
      scannerToggleTitle: "添加料盘时使用条码扫描器",
      scannerToggleDesc: "在此设备上，用“扫描条码以添加”替换快速添加对话框。",
      scannerNotDetected: "未检测到扫描器——连接 USB 条码扫描器后将显示在此处。",
      scannerHardware: "检测到的硬件",
      scannerGeneric: "USB 条码扫描器",
      scannerConnected: "已连接",
      scannerDisconnected: "未连接",
      scannerLastScan: "最近扫描",
      scannerScanToTest: "扫描以测试",
      scannerTestHint: "扫描任意条码进行测试，条码将显示在此处。",
      scannerDbNote: "社区数据库查询遵循 Bambuddy 主应用中的条码扫描设置。与自有库存的匹配始终有效，即使离线也是如此。",
      tabUpdates: '更新',
      // Device tab
      nfcReader: 'NFC 读卡器',
      type: '类型',
