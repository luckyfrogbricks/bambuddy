export default {
  ...
  inventory: {
    ...
    barcode: 'Code-barres',
    gtinCode: 'GTIN',
    gtinCodePlaceholder: 'Code-barres, p. ex. 6938936716785',
    gtinCodeHelp: 'Rempli automatiquement par le scan. Un futur scan de l’un de ces codes retrouvera cette bobine instantanément.',
    skuCode: 'SKU',
    skuCodePlaceholder: 'p. ex. 17600',
    asinCode: 'ASIN',
    asinCodePlaceholder: 'p. ex. B0CJLR62MF',
    otherCodeLabel: 'Code personnalisé :',
  ...
  spoolbuddy: {
    barcode: {
      ...
      waitingSub: "Le scanner s'allume et émet un bip lorsqu'il lit un code.",
      invalidScan: "Impossible de lire ce code-barres — réessayez.",
      enterManually: "Saisir le code manuellement",
      addWithoutBarcode: "Ajouter sans code-barres",
      manualTitle: "Saisir le code-barres",
      manualHint: "Tapez le numéro imprimé sous le code-barres.",
      lookUp: "Rechercher",
      lookingUp: "Recherche…",
      confirmTitle: "Confirmer la nouvelle bobine",
      barcodeScannedTitle: "Code-barres scanné",
      scannedCode: "Scanné",
      unknownColor: "Couleur inconnue",
      rowTag: "Tag",
      rowGross: "Poids brut",
      rowBarcode: "Code-barres",
      rowEst: "Filament estimé",
      rescan: "Rescanner",
      addToInventory: "Ajouter à l'inventaire",
      addWithoutTag: "Ajouter sans tag",
      ...
      chipTag: "Tag",
      chipScale: "Balance",
      chipWaiting: "en attente…",
      chipEmpty: "vide",
      sourceInventory: "Trouvé dans votre inventaire",
      sourceOfd: "Trouvé dans Open Filament Database",
      sourceSpoolmandb: "Trouvé dans SpoolmanDB Community",
      sourceGuessed: "Déduit de l'étiquette",
      sourceLinked: "Lié par vous — code-barres enregistré pour la prochaine fois",
      pillInventory: "Votre inventaire",
      ...
      browseYourBrands: 'Vos marques',
      browseAllBrands: 'Toutes les marques',
      browseColorsCount: '{{count}} couleurs',
      browseByColor: 'Couleur',
      browseClearColor: 'Effacer le filtre couleur',
      browseShowingTop: '{{count}} sur {{total}} affichés — choisissez une marque pour affiner',
      browseEmpty: 'Rien ici',
      browseDisabled: 'Les recherches dans les catalogues communautaires sont désactivées. Activez-les dans l’application web sous Paramètres → Filament pour parcourir le catalogue.',
      browseLoadFailed: 'Impossible de charger le catalogue',
      sourcePicked: 'Choisi dans le catalogue',
      hueRed: 'Rouge',
      hueOrange: 'Orange',
      hueYellow: 'Jaune',
      hueGreen: 'Vert',
    ...
    settings: {
      ...
      tabScale: 'Balance',
      tabScanner: "Scanner",
      scannerToggleTitle: "Utiliser le scanner de codes-barres pour ajouter des bobines",
      scannerToggleDesc: "Remplace la boîte de dialogue d'ajout rapide par « Scanner un code-barres pour ajouter » sur cet appareil.",
      scannerNotDetected: "Aucun scanner détecté — branchez un scanner de codes-barres USB et il apparaîtra ici.",
      scannerHardware: "Matériel détecté",
      scannerGeneric: "Scanner de codes-barres USB",
      scannerConnected: "connecté",
      scannerDisconnected: "non connecté",
      scannerLastScan: "Dernier scan",
      scannerScanToTest: "Scannez pour tester",
      scannerTestHint: "Scannez n'importe quel code-barres pour tester. Le code apparaît ici.",
      scannerDbNote: "Les recherches dans les bases de données communautaires suivent le réglage Scan de code-barres de l'application principale Bambuddy. Les correspondances avec votre propre inventaire fonctionnent toujours, même hors ligne.",
