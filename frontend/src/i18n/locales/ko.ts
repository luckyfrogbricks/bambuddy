export default {
  ...
  inventory: {
    ...
    barcode: '바코드',
    gtinCode: 'GTIN',
    gtinCodePlaceholder: '소매 바코드, 예: 6938936716785',
    gtinCodeHelp: '바코드 스캔 시 자동으로 입력됩니다. 아래 코드 중 하나를 나중에 스캔하면 이 스풀이 즉시 검색됩니다.',
    skuCode: 'SKU',
    skuCodePlaceholder: '예: 17600',
    asinCode: 'ASIN',
    asinCodePlaceholder: '예: B0CJLR62MF',
    otherCodeLabel: '사용자 코드:',
  ...
  spoolbuddy: {
    barcode: {
      ...
      waiting: "스캔 대기 중…",
      waitingSub: "코드를 읽으면 스캐너가 켜지고 비프음이 울립니다.",
      invalidScan: "바코드를 읽을 수 없습니다 — 다시 스캔해 보세요.",
      enterManually: "코드 수동 입력",
      addWithoutBarcode: "바코드 없이 추가",
      manualTitle: "바코드 입력",
      manualHint: "바코드 아래에 인쇄된 숫자를 입력하세요.",
      lookUp: "조회",
      lookingUp: "조회 중…",
      confirmTitle: "새 스풀 확인",
      ...
      chipWaiting: "대기 중…",
      chipEmpty: "비어 있음",
      sourceInventory: "내 인벤토리에서 찾음",
      sourceOfd: "Open Filament Database에서 찾음",
      sourceSpoolmandb: "SpoolmanDB Community에서 찾음",
      sourceGuessed: "라벨에서 추정",
      sourceLinked: "직접 연결함 — 다음을 위해 바코드 저장됨",
      pillInventory: "내 인벤토리",
      ...
      browseTitle: '카탈로그 둘러보기',
      browseYourBrands: '내 브랜드',
      browseAllBrands: '모든 브랜드',
      browseColorsCount: '{{count}}가지 색상',
      browseByColor: '색상',
      browseClearColor: '색상 필터 지우기',
      browseShowingTop: '{{total}}개 중 {{count}}개 표시 — 브랜드를 선택해 좁히세요',
      browseEmpty: '결과 없음',
      browseDisabled: '커뮤니티 카탈로그 조회가 꺼져 있습니다. 웹 앱의 설정 → 필라멘트에서 켜면 카탈로그를 둘러볼 수 있습니다.',
      browseLoadFailed: '카탈로그를 불러오지 못했습니다',
      sourcePicked: '카탈로그에서 선택함',
      hueRed: '빨강',
      hueOrange: '주황',
      hueYellow: '노랑',
      hueGreen: '초록',
    ...
    settings: {
      ...
      tabScale: '저울',
      tabScanner: "스캐너",
      scannerToggleTitle: "스풀 추가 시 바코드 스캐너 사용",
      scannerToggleDesc: "이 기기에서 빠른 추가 대화상자를 '바코드를 스캔하여 추가'로 대체합니다.",
      scannerNotDetected: "스캐너가 감지되지 않음 — USB 바코드 스캐너를 연결하면 여기에 표시됩니다.",
      scannerHardware: "감지된 하드웨어",
      scannerGeneric: "USB 바코드 스캐너",
      scannerConnected: "연결됨",
      scannerDisconnected: "연결 안 됨",
      scannerLastScan: "마지막 스캔",
      scannerScanToTest: "스캔하여 테스트",
      scannerTestHint: "아무 바코드나 스캔하여 테스트하세요. 코드가 여기에 표시됩니다.",
      scannerDbNote: "커뮤니티 데이터베이스 조회는 Bambuddy 기본 앱의 바코드 스캔 설정을 따릅니다. 내 인벤토리와의 일치는 오프라인에서도 항상 작동합니다.",
      tabUpdates: '업데이트',
      nfcReader: 'NFC 리더',
      type: '유형',
      connection: '연결',
